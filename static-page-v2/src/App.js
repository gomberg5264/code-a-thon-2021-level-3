...
function App() {
  return (
    <div>
      <header><h1>Static App (V2)</h1></header>
      ...
      <MoreLink linkTarget="/page1" linkText="See Topic 1" />
      ...
      <MoreLink linkTarget="/page4"  linkText="See Topic 2"/>
