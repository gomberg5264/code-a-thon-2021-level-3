...
function App() {
  ...
  return (
    <div>
      ...
      <input type="text" name="btnPrefix" autoFocus onChange={handleChange} />
      <br />
      ...
      <MoreLink btnPrefix={prefix} linkTarget="/page1" />
      ...
      <MoreLink btnPrefix={prefix} linkTarget="/page2" linkText="See Topic" />
      ...
      <MoreLink btnPrefix={prefix} linkTarget="/page3" />
      ...
      <MoreLink btnPrefix={prefix} linkTarget="/page4" linkText="See Another Topic" />
